    ...
    <section id="shop" class="">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <input type="text" id="SearchProduct2" class="form-control mb-2" placeholder="Search">
                    <ul class="list-group search-res product_filter2">
                        {{-- afficher les produit recherche --}}
                    </ul>
                </div>
            </div>
            <div class="row">
                ...
                if (q.length > 0) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('.product_filter2').html("");
                            $('.product_filter2').html(data.html);
                        }
                    });
                } else {
                    $('.product_filter2').html("");
